...
const mockAchievements = [
  ...
  { id: 8, title: '基于知识图谱的智能问答系统', type: '科研成果', teacherId: 6, teacherName: '刘老师', schoolId: 4, schoolName: '石家庄信息工程职业学院', description: '构建了面向制造业的领域知识图谱，并开发了基于大语言模型和知识图谱的智能问答系统，在多家制造企业完成部署验证。', completionDate: '2024-06-01', tags: ['知识图谱', '大模型', '问答系统'], certificateUrl: '' },
]
