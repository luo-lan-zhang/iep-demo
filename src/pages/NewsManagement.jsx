...
const initialNews = [
  { id: 1, title: '华为与石家庄信息工程职业学院共建鸿蒙创新实验室', type: 'text', content: '华为技术有限公司与石家庄信息工程职业学院签署战略合作协议，共同建设鸿蒙创新实验室。双方将在鸿蒙生态建设、人才培养、技术研发等领域展开深度合作。', publisherName: '华为技术有限公司', publisherType: 'enterprise', status: 'approved', publishDate: '2024-07-25', images: [], files: [], reviewComment: '' },
  { id: 2, title: '腾讯AI大模型培训项目启动', type: 'image', content: '腾讯科技联合石家庄信息工程职业学院、石家庄信息工程职业学院等高校，正式启动AI大模型技术培训项目，面向全校招募30名优秀学生参与。', publisherName: '腾讯科技（深圳）有限公司', publisherType: 'enterprise', status: 'approved', publishDate: '2024-07-22', images: ['https://picsum.photos/seed/ai/800/400'], files: [], reviewComment: '' },
  ...
  { id: 7, title: '智能网联汽车技术论坛圆满落幕', type: 'image', content: '广州小鹏汽车科技有限公司联合石家庄信息工程职业学院举办的智能网联汽车技术论坛在广州圆满落幕。论坛聚焦自动驾驶、车路协同、智能座舱等前沿技术，吸引了来自全国各地的300余名专家学者参与。', publisherName: '广州小鹏汽车科技有限公司', publisherType: 'enterprise', status: 'approved', publishDate: '2024-08-05', images: ['https://picsum.photos/seed/car/800/400', 'https://picsum.photos/seed/tech/800/400'], files: [], reviewComment: '' },
  ...
  { id: 9, title: '深圳南山科技园获评国家级产教融合示范园区', type: 'image', content: '深圳南山科技园经教育部、工信部联合评审，正式获评"国家级产教融合示范园区"。园区现有入驻企业27家，与15所高校建立了深度合作关系，年培养产教融合人才超5000人。', publisherName: '深圳南山科技园管理办公室', publisherType: 'park', status: 'approved', publishDate: '2024-08-12', images: ['https://picsum.photos/seed/park/800/400'], files: [], reviewComment: '' },
  { id: 10, title: '大疆创新发布2025届校园招聘计划', type: 'image', content: '大疆创新科技有限公司正式发布2025届校园招聘计划，面向全国高校招聘嵌入式开发、机械设计、AI算法等方向人才共计200人，其中产教融合定向培养岗位占比40%。', publisherName: '大疆创新科技有限公司', publisherType: 'enterprise', status: 'approved', publishDate: '2024-08-15', images: ['https://picsum.photos/seed/dji/800/400'], files: [{ name: '大疆2025校园招聘简章.pdf', size: 2100000 }], reviewComment: '' },
  { id: 11, title: '石家庄信息工程职业学院与东莞华贝共建电子制造实训中心', type: 'text', content: '石家庄信息工程职业学院与东莞华贝电子科技有限公司签署合作协议，双方将共同建设电子制造实训中心。实训中心建筑面积2000平方米，配备SMT贴片线、自动化测试线等先进设备，年实训能力达800人次。', publisherName: '石家庄信息工程职业学院', publisherType: 'school', status: 'pending', publishDate: '2024-08-18', images: [], files: [{ name: '实训中心建设方案.pdf', size: 3200000 }], reviewComment: '' },
  { id: 12, title: '2024年第二批产教融合项目评审结果公示', type: 'text', content: '产教融合理事会于2024年8月20日完成了第二批产教融合项目的专家评审工作。本次共收到申报项目86项，经专家评审，拟立项42项。现将评审结果予以公示，公示期为2024年8月21日至8月27日。', publisherName: '产教融合理事会', publisherType: 'school', status: 'approved', publishDate: '2024-08-21', images: [], files: [{ name: '评审结果公示.pdf', size: 1500000 }], reviewComment: '' },
]
