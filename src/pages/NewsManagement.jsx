...
const initialNews = [
  ...
  { id: 11, title: '华南理工大学与东莞华贝共建电子制造实训中心', type: 'text', content: '华南理工大学与东莞华贝电子科技有限公司签署合作协议，双方将共同建设电子制造实训中心。实训中心建筑面积2000平方米，配备SMT贴片线、自动化测试线等先进设备，年实训能力达800人次。', publisherName: '华南理工大学', publisherType: 'school', status: 'pending', publishDate: '2024-08-18', images: [], files: [{ name: '实训中心建设方案.pdf', size: 3200000 }], reviewComment: '' },
