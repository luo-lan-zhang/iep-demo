...
const mockTeachingResources = [
  { id: 1, name: '智能仓储系统-项目任务书', teacherId: 1, teacherName: '张晓蕾', schoolId: 1, schoolName: '石家庄信息工程职业学院', difficulty: '初级', domain: '物联网', fileType: '项目任务书', description: '基于RFID的智能仓储管理系统项目任务书，包含项目背景、目标、技术路线、验收标准等内容。', fileCount: 3, status: 'approved', submitDate: '2024-05-10', reviewComment: '内容完整，符合教学要求' },
